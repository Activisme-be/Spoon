...
@section('content')
    @php
        /** @var \App\Domain\Auth\Models\User $userEntity */
    @endphp
        ...
        <div class="row">
            ...
            <div class="col-9"> {{-- Content --}}
                <div class="card shadow-sm border-0">
                    <form id="lock-form" action="{{ route('users.lock.store', $userEntity) }}" method="POST" class="card-body border-0 shadow-sm card-body">
                    ...
                    <div class="card-footer border-top-0 bg-card-footer">
                        <button form="lock-form" type="submit" class="btn btn-danger">Deactiveer</button>
