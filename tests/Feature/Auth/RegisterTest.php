...
class RegisterTest extends TestCase
{
    ...
    public function testUserCanRegister(): void
    {
        ...
        Event::assertDispatched(Registered::class, function ($e) use ($user): bool {
    ...
    {
        $response = $this->from($this->registerGetRoute())->post($this->registerPostRoute(), [
            'name' => 'John Doe', 'email' => 'invalid-email', 'password' => 'i-love-laravel', 'password_confirmation' => 'i-love-laravel',
        ]);
    ...
    {
        $response = $this->from($this->registerGetRoute())->post($this->registerPostRoute(), [
            'name' => 'John Doe', 'email' => 'john@example.com', 'password' => '', 'password_confirmation' => '',
        ]);
    ...
    {
        $response = $this->from($this->registerGetRoute())->post($this->registerPostRoute(), [
            'name' => 'John Doe', 'email' => 'john@example.com', 'password' => 'i-love-laravel', 'password_confirmation' => '',
        ]);
    ...
    {
        $response = $this->from($this->registerGetRoute())->post($this->registerPostRoute(), [
            'name' => 'John Doe', 'email' => 'john@example.com', 'password' => 'i-love-laravel', 'password_confirmation' => 'i-love-symfony',
        ]);
